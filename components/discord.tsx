...
const DiscordBtn = () => {
  return (
    <Link
      href="https://discord.gg/2cXPZzXU"
      target="_blank"
    ...
    >
      <IconIonLogoDiscord className="size-4" />
    </Link>
  )
}

export default DiscordBtn
const IconIonLogoDiscord = ({ ...props }: Omit<React.SVGProps<SVGSVGElement>, 'children'>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="640" height="512" {...props} viewBox="0 0 640 512">
    <path
      fill="currentColor"
